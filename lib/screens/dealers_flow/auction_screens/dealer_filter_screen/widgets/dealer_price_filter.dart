...
class DealerPriceFilter extends StatefulWidget {
  const DealerPriceFilter({super.key});

  @override
  State<DealerPriceFilter> createState() => _DealerPriceFilterState();
}

class _DealerPriceFilterState extends State<DealerPriceFilter> {
  double _lowerValue = 200000;

  double _upperValue = 500000;
  List<String> DealerPriceFilter = [
    "Under 3 lakh",
    "From 3 lakh - 5 lakh",
    "From 5 lakh - 10 lakh",
