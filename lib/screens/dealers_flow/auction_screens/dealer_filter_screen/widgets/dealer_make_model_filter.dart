...
class DealerMakeModelFilters extends StatefulWidget {
  const DealerMakeModelFilters({super.key});

  @override
  State<DealerMakeModelFilters> createState() => _DealerMakeModelFiltersState();
}

class _DealerMakeModelFiltersState extends State<DealerMakeModelFilters> {
  List<String> brand = [
    "Maruti",
    "Hyundai",
    "Tata",
