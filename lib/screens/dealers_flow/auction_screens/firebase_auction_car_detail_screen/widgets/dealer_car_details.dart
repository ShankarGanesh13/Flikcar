...
class FirebaseDealerCarDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    data = [
      ...
      "Road Tax \nValidity: ${car.properties.roadTaxValidity == null ? "Life Time" : formatter.format(DateTime.fromMillisecondsSinceEpoch(car.properties.roadTaxValidity!))}",
      "Insurance\nValidity: ${car.properties.insuranceValidity == null ? "Life Time" : formatter.format(DateTime.fromMillisecondsSinceEpoch(car.properties.insuranceValidity!))}",
