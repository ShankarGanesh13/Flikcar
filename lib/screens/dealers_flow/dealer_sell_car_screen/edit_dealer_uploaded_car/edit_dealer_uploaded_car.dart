...
import 'package:flikcar/screens/dealers_flow/dealer_sell_car_screen/edit_dealer_uploaded_car/widgets/edit_details_dropdown.dart';
import 'package:flikcar/screens/dealers_flow/dealer_sell_car_screen/edit_dealer_uploaded_car/widgets/edit_rto.dart';
...
class EditDealerListedCar extends StatefulWidget {
  final FirebaseBuyerCar car;
  const EditDealerListedCar({super.key, required this.car});

  @override
  State<EditDealerListedCar> createState() => _EditDealerListedCarState();
}

class _EditDealerListedCarState extends State<EditDealerListedCar> {
  ...
  void initState() {
    ...
    regYearController = TextEditingController(
        text: widget.car.properties.registrationYear.toString());
    manuYearController = TextEditingController(
        text: widget.car.properties.manufacturedYear.toString());
    seatController =
        TextEditingController(text: widget.car.properties.seat.toString());
    kmsController =
        TextEditingController(text: widget.car.properties.kmsDriven.toString());
    ...
    varient = widget.car.properties.variant;
    color = widget.car.properties.color;
    fuelType = widget.car.properties.fuelType;
    ownerType = widget.car.properties.ownerType;
    rtoLocation = widget.car.properties.RTOlocation;
    transmission = widget.car.properties.transmission;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    EditDetailsDropDown(
                      ...
                      ownershipOnChanged: (value) {
                        ownerType = value;
                      },
                      transmissionOnChanged: (value) {
                        transmission = value;
                      },
                    ),
